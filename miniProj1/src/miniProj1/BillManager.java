...
public class BillManager  {
	...
	public static void main(String[] args) {
 		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
			     introfile = new File("/Users/imransmacbook/Desktop/introfile.txt");
				     itemfile=new File("/Users/imransmacbook/Desktop/itemfile.txt");
			    	  pricefile=new File("/Users/imransmacbook/Desktop/pricefile.txt");
	...
	private void initialize() {
	 ...
	 public void savetoDB() {
		 ...
		 try {
			 ...
			 con = DriverManager.getConnection("jdbc:mysql://localhost:3306/imran?useSSL=true","root","root123");
